...
# Store locations
store_locations = ["Sydney", "Melbourne", "Brisbane", "Perth", "Adelaide"]
...
while records_generated < num_records:
    ...
    for product in selected_products:
        ...
        data.append(order)
    records_generated += num_orders

# Create DataFrame
df = pd.DataFrame(data)

# Save to CSV, overwriting if it exists
csv_path = r"C:\Users\kingk\Desktop\datwarehouse_blog\sourceData\in_store_dummy_data.csv"
